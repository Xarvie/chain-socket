...
// XTODO: Ideally this would be also constrained against the various char types,
...
namespace {
    ...
    void XmlEncode::encodeTo( std::ostream& os ) const {
        ...
        for( std::size_t fd = 0; fd < m_str.size(); ++ fd ) {
            uchar c = m_str[fd];
            switch (c) {
            case '<':   os << "&lt;"; break;
            case '&':   os << "&amp;"; break;
...
namespace Catch {
    ...
    void XmlReporter::testGroupEnded( TestGroupStats const& testGroupStats ) {
        ...
        // XTODO: Check testGroupStats.aborting and act accordingly.
